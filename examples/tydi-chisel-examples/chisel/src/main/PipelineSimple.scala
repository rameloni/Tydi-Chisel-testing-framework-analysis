...
class Generated_0_30_soHLkh1p_30 extends PhysicalStreamDetailed(e = new Stats, n = 1, d = 1, c = 1, r = false, u = Null())
...
/** Stream, defined in pipelineSimple_types. */
class Generated_0_36_xeHH4woS_24 extends PhysicalStreamDetailed(e = new NumberGroup, n = 1, d = 1, c = 1, r = false, u = Null())
...
/**
 * Streamlet, defined in pipelineSimple.
 * Top level interface.
 */
...
/**
 * Implementation, defined in pipelineSimple.
...
class NonNegativeFilter extends Instance_NonNegativeFilter_interface_RefToVargenerated_0_36_KLOZ7sts_25_1 {
  ...
  printf("inStream: %d, outStream: %d\n", inStream.el.value, outStream.el.value)
}
...
object PipelineSimpleVerilog extends App {
  Emit(
    "output/PipelineSimple",
    () => new PipelineSimple(),
    "PipelineSimple"
  ).verilog()
}

object PipelineSimpleFIRRTL extends App {
  Emit(
    "output/PipelineSimple",
    () => new PipelineSimple(),
    "PipelineSimple"
...
object PipelineSimpleGenerateHGDB extends App {
  Emit(
    "output/PipelineSimple",
    () => new PipelineSimple(),
    "PipelineSimple"
